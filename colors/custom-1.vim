...
hi clear
let g:colors_name = 'custom-1'

let s:t_Co = exists('&t_Co') && !empty(&t_Co) && &t_Co > 1 ? &t_Co : 1

if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    let g:terminal_ansi_colors = ['#1f1f1f', '#fff261', '#66d4cf', '#fff261', '#70d7ff', '#ff6482', '#ff6482', '#dfdfe0', '#7f8c98', '#fff261', '#66d4cf', '#ff6961', '#70d7ff', '#ff6482', '#ff6482', '#dfdfe0']
    if has('nvim')
    ...
    hi PmenuThumb guifg=#1f1f1f guibg=#1f1f1f gui=NONE cterm=NONE
    ...
    hi StatusLine guifg=#dfdfe0 guibg=#1f1f1f gui=NONE cterm=NONE
    ...
    hi Search guifg=#dfdfe0 guibg=#1f1f1f gui=NONE cterm=NONE
    hi Visual guifg=NONE guibg=#1f1f1f gui=NONE cterm=NONE
