...
hi clear
let g:colors_name = 'custom-candy'
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    hi Normal guifg=#dfdfe0 guibg=#1f1f1f gui=NONE cterm=NONE
    hi Cursor guifg=#1f1f1f guibg=#dfdfe0 gui=NONE cterm=NONE
    hi None guifg=#dfdfe0 guibg=NONE gui=NONE cterm=NONE
    hi CursorLineNr guifg=#dfdfe0 guibg=#2f3037 gui=NONE cterm=NONE
    hi EndOfBuffer guifg=#1f1f1f guibg=#1f1f1f gui=NONE cterm=NONE
    ...
    hi IncSearch guifg=#1f1f1f guibg=#fef937 gui=NONE cterm=NONE
    ...
    hi Error guifg=#1f1f1f guibg=#fff261 gui=NONE cterm=NONE
    ...
    if g:xcode_match_paren_style
      hi MatchParen guifg=#1f1f1f guibg=#fef937 gui=NONE cterm=NONE
    else
